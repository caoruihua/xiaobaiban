...
class TestXiaobaiban(unittest.TestCase):
    ...
    def test03ShanchuPinglun(self):
        ...
        self.d(resourceId="com.esenyun.workline:id/iv_content_action_1").click()
        time.sleep(1)
        self.d(resourceId="com.esenyun.workline:id/tv_text", text=u"我发布的").click()
        time.sleep(1)
        self.d(resourceId="com.esenyun.workline:id/tv_filter_action_confirm").click()
        time.sleep(1)
        self.d(text=u'测试').click()
        time.sleep(1)
        ...
        time.sleep(1)
        self.d.swipe(0.666,0.926,0.666,0.229,0.6)
        time.sleep(1)
        self.d.swipe(0.666, 0.926, 0.666, 0.229, 0.6)
        time.sleep(1)
        self.d.long_click(0.336, 0.492,1)
        time.sleep(1)
    ...
    def test04RizhiAndShenpi(self):
        ...
        time.sleep(1)
        self.assertTrue(self.d(text=u"结论").exists,"查看日志失败")
        time.sleep(1)
        self.log.info_log("审批测试通过")

    def test05chajian(self):
        u'''测试插件功能'''
        self.log.info_log("插件测试开始")
        time.sleep(3)
        self.d(text=u"我的小白板").click()
        time.sleep(1)
        self.d(resourceId="com.esenyun.workline:id/iv_content_action_1").click()
        ...
        self.d(text=u"测试").click()
        time.sleep(1)
        self.d.swipe(0.376, 0.856, 0.376, 0.133, 0.5)
        time.sleep(1)
        self.d(text=u"评论").click()
        time.sleep(1)
        self.d(text=u'任务').click()
        time.sleep(1)
        self.d(resourceId="com.esenyun.workline:id/subtitle").click()
        time.sleep(1)
        self.d(text=u'评论').click()
        self.log.info_log("插件测试完成")
